...
<body>
    ...
    echo "Birinci Öğrenci";
    echo "<pre>";
    print_r($ogrenciDetaylari["ogrenci1"]);
    echo "</pre>";
    ...
    echo "İkinci Öğrenci";
    echo "<pre>";
    print_r($ogrenciDetaylari["ogrenci2"]);
    echo "</pre>";
    ...
    $ogr_notu = rand(0,100);
    $sonuclar = fmod($ogr_notu,2);
    if ($sonuclar== 0)
     {
        echo "Sayı Çift:$ogr_notu ";
    }

        else {
            echo "Sayı Tek:$ogr_notu ";
        }
    ...
    if($ogr_notu>=50)
{
    ...
    $dogumyılı=rand(1990,2012);
    echo "Doğum Yılı = $dogumyılı";
    echo "<br>";
    $bekle=(2022-$dogumyılı);
    if ($bekle >=18) {
        echo "Ehliyet Alabilirsiniz.";
    }

    else {
        echo "Ehliyet Almak İçin $bekle Yıl Beklemelisiniz.";
    }
